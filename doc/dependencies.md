...
These are the dependencies currently used by TheMinerzCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/theminerzcoinnl
Keybase  - https://keybase.io/team/theminerzcoin/
