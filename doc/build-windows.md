...
Below are some notes on how to build TheMinerzCoin for Windows.

The options known to work for building TheMinerzCoin on Windows are:

* On Linux, using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Bionic 18.04 is required
and is the platform used to build the TheMinerzCoin Windows release binaries.
...
It's not possible to build the TheMinerzCoin code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the TheMinerzCoin source code).
