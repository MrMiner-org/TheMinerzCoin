...
class HTTPBasicsTest(BitcoinTestFramework):
    ...
    def conf_setup(self):
        #Append rpcauth to theminerzcoin.conf before initialization
        ...
        with open(self.nodes[0].datadir_path / "theminerzcoin.conf", "a", encoding="utf8") as f:
            f.write(rpcauth + "\n")
            f.write(rpcauth2 + "\n")
            f.write(rpcauth3 + "\n")
        with open(self.nodes[1].datadir_path / "theminerzcoin.conf", "a", encoding="utf8") as f:
            f.write("rpcuser={}\n".format(self.rpcuser))
