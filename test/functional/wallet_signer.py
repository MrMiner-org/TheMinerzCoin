...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_multiple_signers(self):
        ...
        assert_raises_rpc_error(-1, "GetExternalSigner:  than one external signer found", self.nodes[1].createwallet, wallet_name='multi_hww', disable_private_keys=True, descriptors=True, external_signer=True)
