...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s theminerzcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  theminerzcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded theminerzcoin transaction") + "\n" +
              "  theminerzcoin-tx [options] -create [commands]   " + _("Create hex-encoded theminerzcoin transaction") + "\n" +
              "\n";
