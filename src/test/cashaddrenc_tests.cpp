...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"theminerzcoin:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "theminerzcoin:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "theminerzcoin:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"theminerzcoin:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "theminerzcoin:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "theminerzcoin:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
