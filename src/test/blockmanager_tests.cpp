...
BOOST_AUTO_TEST_CASE(blockmanager_flush_block_file)
{
    ...
    FlatFilePos pos1{blockman.SaveBlockToDisk(block1, 1, nullptr)};

    // Write second block
    FlatFilePos pos2{blockman.SaveBlockToDisk(block2, 2, nullptr)};
    ...
    BOOST_CHECK(blockman.SaveBlockToDisk(block3, 3, &pos2) == pos2);
    // Metadata is updated...
