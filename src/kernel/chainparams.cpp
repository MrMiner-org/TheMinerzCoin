...
public:
    CMainParams() {
        ...
        consensus.nTargetTimespan = 10 * 60; // 16 mins
        consensus.nTargetSpacingV1 = 5;
        consensus.nTargetSpacing = 5;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.fPoSNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 2; // 90% of 2016
        ...
        checkpointData = {
            {
                {   0, uint256S("0x0000060b614d1629e0ada5da36d52ad994c9c994166d88b90fada164e586b9ba")}, // genesisblock
            }
        };
...
public:
    CTestNetParams() {
        ...
        */
        ...
        checkpointData = {
            {
                {  90235, uint256S("0x00002a0adb0f284f8384e2e58cd16c93a6500bcc9e05441355b526a326d32013")}, // initial checkpoint
