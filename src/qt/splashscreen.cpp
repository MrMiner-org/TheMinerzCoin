    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextBlackcoin   = QChar(0xA9)+QString(" %1-%2 ").arg(2014).arg(2018) + QString("The theminerzcoin developers");
    QString copyrightTextBlackmore   = QChar(0xA9)+QString(" %1-%2 ").arg(2018).arg(COPYRIGHT_YEAR) + QString("The theminerzcoin More developers");
