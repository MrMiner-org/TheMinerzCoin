...
const QString BITCOIN_IPC_PREFIX("theminerzcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/theminerzcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/theminerzcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/theminerzcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click theminerzcoin: links
...
//
// OSX-specific way of handling theminerzcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in theminerzcoin: URIs
