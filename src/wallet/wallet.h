...
enum WalletFeature
{
    FEATURE_BASE = 10102, // the earliest version new wallets supports (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 10102, // wallet encryption
    FEATURE_COMPRPUBKEY = 10102, // compressed public keys

    FEATURE_HD = 10102, // Hierarchical key derivation after BIP32 (HD Wallet)
