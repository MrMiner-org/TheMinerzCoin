 ...
 * between theminerzcoind, and theminerzcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("theminerzcoin-shutoff");
...
std::string LicenseInfo()
{
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find TheMinerzCoin useful. "
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("theminerzcoin-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("TheMinerzCoin More version %s\n", FormatFullVersion());
}
