...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/theminerzcoin.conf}
...
then
  ...
  echo -e "To safely generate a theminerzcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example theminerzcoin.conf file in share/examples/'
