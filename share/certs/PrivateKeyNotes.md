...
unlocked to sign the TheMinerzCoin-Qt.app bundle.
...
allowing somebody to distribute a TheMinerzCoin-Qt.app or theminerzcoin-qt-setup.exe with a valid
...
that the theminerzcoin-qt.exe file inside the installer had not been tampered with.
